            ...
            <div class="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center relative">
                <div class="animate-slide-up">
                    ...
                    <h1 class="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-800 dark:text-white mb-4 leading-tight">
                        Transformez votre <span class="text-amber-900 dark:text-amber-400 relative">
                            engagement
                    ...
                    <div class="flex flex-wrap gap-4">
                        ...
                        <a href="#features" class="px-6 py-3 border-2 border-[#D4A574] text-amber-900 dark:text-amber-400 dark:text-amber-900 dark:text-amber-400 rounded-lg font-semibold hover:bg-[#FFD6BA] dark:hover:bg-gray-700 transition transform hover:scale-105 flex items-center gap-2">
                            <span>En savoir plus</span>
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 14l-7 7m0 0l-7-7m7 7V3"/></svg>
                        </a>
                    </div>
                ...
                <div class="hidden md:block animate-scale-in">
                    <div class="glass-panel border-2 border-[#00FFFF] rounded-none p-8 shadow-[0_0_20px_rgba(0,255,255,0.2)] relative">
                        ...
                        <div class="absolute -bottom-6 -left-6 text-3xl animate-float animation-delay-200 text-[#00FFFF]">✨</div>
                        <div class="grid grid-cols-3 gap-4 text-center">
                            <div class="glass-panel border border-[#FF00FF]/30 rounded-none p-4 hover:border-[#FF00FF] hover:shadow-[0_0_10px_#FF00FF] transition-all duration-200 cursor-pointer">
                                <div class="text-4xl font-bold text-[#FF00FF] font-heading">1,234</div>
                                <div class="text-sm text-[#E0E0E0]/70 mt-1 font-mono">Points</div>
                                <div class="text-xs text-[#00FFFF] mt-1 font-mono">+10/jour</div>
                            </div>
                            <div class="glass-panel border border-[#FF00FF]/30 rounded-none p-4 hover:border-[#FF00FF] hover:shadow-[0_0_10px_#FF00FF] transition-all duration-200 cursor-pointer">
                                <div class="text-4xl font-bold text-[#FF9900] font-heading">⭐⭐⭐</div>
                                <div class="text-sm text-[#E0E0E0]/70 mt-1 font-mono">Grades</div>
                                <div class="text-xs text-[#00FFFF] mt-1 font-mono">Prochain: Or</div>
                            </div>
                            <div class="glass-panel border border-[#FF00FF]/30 rounded-none p-4 hover:border-[#FF00FF] hover:shadow-[0_0_10px_#FF00FF] transition-all duration-200 cursor-pointer">
                                <div class="text-4xl font-bold text-[#00FFFF] font-heading">5</div>
                                <div class="text-sm text-[#E0E0E0]/70 mt-1 font-mono">Rewards</div>
                                <div class="text-xs text-[#FF00FF] mt-1 font-mono">à échanger</div>
                            </div>
                        </div>
                        <div class="mt-6 glass-panel border-t-2 border-t-[#00FFFF] rounded-none p-4">
                            <div class="flex items-center justify-between mb-2">
                                <span class="text-sm font-mono text-[#E0E0E0]/70">Progression</span>
                                <span class="text-sm text-[#00FFFF] font-mono font-bold">75%</span>
                            </div>
                            <div class="w-full bg-[#2D1B4E] rounded-none h-4 overflow-hidden border border-[#00FFFF]">
                                <div class="h-full bg-gradient-to-r from-[#FF9900] via-[#FF00FF] to-[#00FFFF] transition-all duration-1000" style="width: 75%"></div>
                            </div>
                            <div class="text-xs text-[#E0E0E0]/50 mt-2 font-mono">150 points pour le prochain grade</div>
                        </div>
                    </div>
                </div>
                            <div class="bg-white dark:bg-gray-600 rounded-xl p-4 shadow hover:shadow-lg transition transform hover:-translate-y-1 cursor-pointer">
                                <div class="text-4xl font-bold text-amber-900 dark:text-amber-400">⭐⭐⭐</div>
                            ...
                            <div class="bg-white dark:bg-gray-600 rounded-xl p-4 shadow hover:shadow-lg transition transform hover:-translate-y-1 cursor-pointer">
                                <div class="text-4xl font-bold text-amber-900 dark:text-amber-400">5</div>
                                <div class="text-sm text-gray-600 dark:text-gray-200 mt-1 font-medium">Rewards</div>
                                <div class="text-xs text-amber-900 dark:text-amber-400 mt-1">à échanger</div>
                            </div>
                        </div>
                        <div class="mt-6 bg-white dark:bg-gray-600 rounded-xl p-4">
                            <div class="flex items-center justify-between mb-2">
                                ...
                                <span class="text-sm text-amber-900 dark:text-amber-400 font-semibold">75%</span>
                            </div>

        ...
        <div class="flex justify-between h-16">
            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex items-center">
                    ...
                    <!-- Notification Bell -->
                    <a href="{{ route('notifications.index') }}" class="relative inline-flex items-center px-2 py-2 text-[#D4A574] hover:bg-[#FFF2EB] rounded-md">
                        ...
                        @endphp
                        @if($unreadCount > 0)
                            <span class="absolute top-0 right-0 -mt-1 -mr-1 flex h-5 w-5 items-center justify-center rounded-full bg-red-500 text-xs text-white">{{ $unreadCount }}</span>
                        @endif
                    </a>
                </div>
            </div>

            <!-- Right side: Points + Settings -->
